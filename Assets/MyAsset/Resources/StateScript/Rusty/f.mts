...
export function StateDef_0_ID(entity : any) {
    //List<Int>
    const List_Int =
    ...
    let selfOnGrd : boolean = CS.LuaCondition.isEntityOnGround(entity)
    let isPressed_A: boolean = CS.LuaCondition.isEntityOnGround(entity, "_a");
    let isPressed_B: boolean = CS.LuaCondition.isEntityOnGround(entity, "_b");
...
export function StateDef_0_Param(entity: any) { 
    const List_Object =
